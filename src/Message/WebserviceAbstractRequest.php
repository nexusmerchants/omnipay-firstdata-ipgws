...
namespace NexusMerchants\FirstData\Message;
...
abstract class WebserviceAbstractRequest extends AbstractRequest
{
    ...
    protected $liveWsdl = "https://www.ipg-online.com/ipgapi/services/order.wsdl";
    ...
    protected $liveEndpoint = 'https://www.ipg-online.com/ipgapi/services';
...
';
    ...
    public function buildCurlClient()
    {
        ...
        //curl_setopt($this->curl, CURLOPT_STDERR, fopen('php://stderr', 'w'));
